...
namespace XnaFan.ImageComparison
{
    public static class ExtensionMethods
    {
        ...
        {
            Bitmap thisOne = (Bitmap)img1.Resize(48, 48).GetGrayScaleVersion();
            Bitmap theOtherOne = (Bitmap)img2.Resize(48, 48).GetGrayScaleVersion();
            byte[,] differences = new byte[48, 48];
        ...
        {
            using (Bitmap thisOne = (Bitmap)img.Resize(48, 48).GetGrayScaleVersion())
            {
                byte[,] grayScale = new byte[48, 48];
